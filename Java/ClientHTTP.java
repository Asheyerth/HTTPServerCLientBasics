...
public class ClientHTTP {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Set latch to block the program from end until the asyn response comes
        ...
        HttpRequest requestNumero = HttpRequest.newBuilder()
        ...
        HttpRequest requestTilde = HttpRequest.newBuilder()
                .uri(URI.create("http://127.0.0.1:5001/tilde")) // url
                .GET() // specify the type of request
                .header("Content-Type", "text/html;charset=utf-8") // headers format
                .build(); // to construct objects step by step.
        ...
        // creates an immutable HttpRequest instance that you can use to send the
        // request.
        ...
        HttpResponse<String> response = client.send(requestNumero,
        ...
        futureResponse.thenAccept(body -> {
            ...
            latch.countDown(); // Signal that the async operation is done
        });

        latch.await(); // Block here until the latch is counted down
